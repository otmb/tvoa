 ...
 * Copyright (c) 2009-2011 by tvoa, Inc. All Rights Reserved.
...
//@interface tvoaObject : NSObject
//@end

@interface tvoaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[tvoaObject class]])
		{
			for (NSString *key in [[(tvoaObject*)o modules] allKeys])
			{
